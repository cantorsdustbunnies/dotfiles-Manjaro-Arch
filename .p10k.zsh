# Generated by Powerlevel10k configuration wizard on 2019-08-20 at 04:01 MDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 05207.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=055
  ...
  function prompt_example() {
    p10k segment -f 159 -i '⭐' -t 'hello, %n'
  }
  function prompt_face(){
	  p10k segment -f 011 -i '' 
  }
